...
=begin 
  ...
  def create
    ...
    respond_to do |format|
      if @event.save
        format.html { redirect_to(@event, :notice => noticeInfo('Event was successfully created.')) }
  ...
  def update
    ...
    respond_to do |format|
      if @event.update_attributes(params[:event])
        format.html { redirect_to(@event, :notice => noticeInfo('Event was successfully updated.')) }
        format.xml  { head :ok }
      else
